...
<section>
 ...
 <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls"  data-bs-slide="next">
   ...
   <span class="visually-hidden">Next</span>
    ...
    <div class="container">
    <h3 class="text-red text-center"><i> It's Time To Travel Welcome To Airlines</i></h3>                                                      
                        </div>
                    </div>
                </div>
            </div>
...
Marine Drive, Cochin-682 031.</p></strong>
      ...
      <div class="col-4 ">  
        ...
        <strong><p class="mt-4 text-center text-info">An airport is an aerodrome with extended facilities, mostly for commercial air transport. Airports often have facilities to store and maintain aircraft, and a control towe.</p></strong>
      </div> 
</div>
</div>
</section>
...
<footer class="container-fluid text-center">   
  ...
  <p>&copy 2019-2020  company.INC &middot;<a href="#" class="text-white"> privacy</a>&middot; <a href="#"  class="text-white">terms</a></p>
  </footer>
